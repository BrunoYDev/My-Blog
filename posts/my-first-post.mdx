...
excerpt: 'Booting up the system... A welcome message from a developer nostalgic for an era he never knew.'
tags:
  - welcome
  - random
pinned: true
...
<div style={{ textAlign: 'center', margin: '30px 0' }}>
  <Image 
    src="/images/welcomePostGif.gif" 
    alt="Welcome to the Internet GIF"
    width={400} 
    height={150} 
    unoptimized={true}
  />
